...
QT_MOC_LITERAL(14, 21), // "productButtonIdReturn"
QT_MOC_LITERAL(36, 0), // ""
QT_MOC_LITERAL(37, 24) // "productButtonClickedToId"

    },
    "ProductWidget\0productButtonIdReturn\0"
    "\0productButtonClickedToId"
};
...
void ProductWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->productButtonIdReturn((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->productButtonClickedToId(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProductWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProductWidget::productButtonIdReturn)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ProductWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void ProductWidget::productButtonIdReturn(int _t1)
{
